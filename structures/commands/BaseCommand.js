 ...
 */
    ...
    _checkArguments() {
        ...
        for (let i = 0; i < this.args.length; i++) {
            ...
            if (param.required && arg == undefined) {
        ...
        this.params.forEach((param, index) => {
            ...
            switch (param.type) {
                ...
                case 'everyone':
                    ...
                    break;
                case 'float':
                    argument = isNaN(arg) || isInt(arg) ? null : parseFloat(arg);

                    break;
                case 'int':
                    argument = isNaN(arg) || !isInt(arg) ? null : parseInt(arg);
